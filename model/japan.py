...
class Japan(db.Model):
    ...
    def __repr__(self):
        ...
        """
        return f"Japan(id={self.id}, title={self._title}, comment={self._comment}, content={self._content}, user_id={self._user_id})"
...
def initJapans():
    """
    The initJapan function creates the Post table and adds tester data to the table.
